...
plt.grid()
plt.title('title')
line0 = axes.plot(np.zeros(size))[0]
line1 = axes.plot(np.zeros(size))[0]
line2 = axes.plot(np.zeros(size))[0]
line3 = axes.plot(np.zeros(size))[0]
...
while byte:
    ...
    line0.set_ydata(num2[0::4]/2**3)
    line1.set_ydata(num2[1::4]/2**7)
    line2.set_ydata(num2[2::4]/2**7)
    line3.set_ydata(num2[3::4]/2**1)
