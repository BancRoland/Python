...
velCell1=3 #hanyadik távolságcella az RV mátrixon egy gyalogos
velCell2=4
...
for j in np.arange(7,12):
    ...
    Inner1=(c/cFrq/2*velCell1)*c/2/(2**j*ffti)/2
    Inner2=(c/cFrq/2*velCell2)*c/2/(2**j*ffti)/2
    print(f'{Lon}, {Lat}, {Outer:.0f}, 00000000, 80000000, 3, dS= {2**j*ffti}     Tb=64ms')
    print(f'{Lon}, {Lat}, {Inner1:.0f}, 000000ff, 800000ff, 3, dS= {2**j*ffti}    Vr=V0/3')
    print(f'{Lon}, {Lat}, {Inner2:.0f}, 0000ff00, 8000ff00, 3, dS= {2**j*ffti}    Vr=V0/4')
